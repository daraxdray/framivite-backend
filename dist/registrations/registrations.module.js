...
exports.RegistrationsModule = RegistrationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [registrations_service_1.RegistrationsService, compositor_service_1.CompositorService],
        exports: [registrations_service_1.RegistrationsService, compositor_service_1.CompositorService],
    })
], RegistrationsModule);
