...
exports.CompositorService = void 0;
    ...
    async compositePhoto(framePathOrUrl, userPhotoPath, framePosition, outputPath) {
        try {
            ...
            const resizedPhotoBuffer = await photoPipeline
                ...
                .toBuffer();
            const canvasBuffer = await (0, sharp_1.default)({
                create: {
                    width: frameWidth,
                    height: frameHeight,
                    channels: 4,
            ...
            throw new common_1.InternalServerErrorException(`Photo compositing failed: ${error.message}`);
        }
    }
    async createFallbackFrame(targetPath) {
...
exports.CompositorService = CompositorService;
exports.CompositorService = CompositorService = __decorate([
    (0, common_1.Injectable)()
], CompositorService);
//# sourceMappingURL=compositor.service.js.map